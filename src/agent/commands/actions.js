...
export const actionsList = [
	{
		name: "!newAction",
		description:
			"Perform new and unknown custom behaviors. IMPORTANT: Do NOT use for building structures, houses, or walls - use !buildStructure instead to ensure 3D accuracy.",
		params: {
			prompt: {
				type: "string",
				description:
		...
		perform: async function (agent, prompt) {
			...
			if (!settings.allow_insecure_coding) {
				agent.openChat(
					"newAction is disabled. Enable with allow_insecure_coding=true in settings.js",
				);
	...
	},
	{
		...
		params: {
			...
			follow_dist: {
				type: "float",
				description: "The distance to follow from.",
				domain: [0, Infinity],
			},
		},
	...
	},
	{
		...
		params: {
			...
			closeness: {
				type: "float",
				description: "How close to get to the location.",
				domain: [0, Infinity],
			},
		},
	...
	},
	{
		...
		params: {
			...
			search_range: {
				type: "float",
				description: "The range to search for the block. Minimum 32.",
				domain: [10, 512],
			},
		},
	...
	},
	{
		...
		params: {
			...
			search_range: {
				type: "float",
				description: "The range to search for the entity.",
				domain: [32, 512],
			},
		},
	...
	},
	{
		...
		params: {
			distance: {
				type: "float",
				description: "The distance to move away.",
				domain: [0, Infinity],
			},
		},
	...
	},
	{
		...
		params: {
			name: {
				type: "string",
				description: "The name to remember the location as.",
			},
		},
	...
	},
	{
		...
		params: {
			item_name: {
				type: "ItemName",
				description: "The name of the item to consume.",
			},
		},
	...
	},
	{
		...
		params: {
			item_name: {
				type: "ItemName",
				description: "The name of the item to put in the chest.",
			},
			num: {
				type: "int",
				description: "The number of items to put in the chest.",
				domain: [1, Number.MAX_SAFE_INTEGER],
			},
		},
	...
	},
	{
		...
		params: {
			item_name: {
				type: "ItemName",
				description: "The name of the item to discard.",
			},
			num: {
				type: "int",
				description: "The number of items to discard.",
				domain: [1, Number.MAX_SAFE_INTEGER],
			},
		},
		perform: runAsAction(async (agent, item_name, num) => {
	...
	},
	{
		...
		params: {
			...
			num: {
				type: "int",
				description: "The number of blocks to collect.",
				domain: [1, Number.MAX_SAFE_INTEGER],
			},
		},
		perform: runAsAction(
	...
	},
	{
		...
		params: {
			recipe_name: {
				type: "ItemName",
				description: "The name of the output item to craft.",
			},
			num: {
				type: "int",
				description:
	...
	},
	{
		...
		params: {
			item_name: {
				type: "ItemName",
				description: "The name of the input item to smelt.",
			},
			num: {
				type: "int",
				description: "The number of times to smelt the item.",
				domain: [1, Number.MAX_SAFE_INTEGER],
			},
		},
		perform: runAsAction(async (agent, item_name, num) => {
	...
	},
	{
		...
		params: {
			type: {
				type: "int",
				description: "The number of seconds to stay. -1 for forever.",
				domain: [-1, Number.MAX_SAFE_INTEGER],
			},
		},
	...
	},
	{
		...
		params: {
			mode_name: {
				type: "string",
				description: "The name of the mode to enable.",
			},
			on: {
				type: "boolean",
				description: "Whether to enable or disable the mode.",
			},
		},
	...
	},
	{
		...
		params: {
			id: {
				type: "int",
				description:
					"The id number of the villager that you want to trade with.",
			},
		},
	...
	},
	{
		...
		params: {
			...
			index: {
				type: "int",
				description: "The index of the trade you want executed (1-indexed).",
				domain: [1, Number.MAX_SAFE_INTEGER],
			},
			count: {
				type: "int",
				description: "How many times that trade should be executed.",
				domain: [1, Number.MAX_SAFE_INTEGER],
			},
		},
	...
	},
	{
		...
		params: {
			player_name: {
				type: "string",
				description: "The name of the player to send the message to.",
			},
		...
		perform: async function (agent, player_name, message) {
			...
			if (
				...
				!convoManager.inConversation(player_name)
			)
				convoManager.forceEndCurrentConversation();
			else if (convoManager.inConversation(player_name))
				agent.history.add(
					"system",
					"You are already in conversation with " +
						player_name +
						". Don't use this command to talk to them.",
				);
	...
	},
	{
		...
		params: {
			player_name: {
				type: "string",
				description: "The name of the player to end the conversation with.",
			},
		},
	...
	},
	{
		...
		params: {
			...
			direction: {
				type: "string",
				description:
					'How to look ("at": look at the player, "with": look in the same direction as the player)',
			},
		},
		perform: async function (agent, player_name, direction) {
			...
			let result = "";
			const actionFn = async () => {
				result = await agent.vision_interpreter.lookAtPlayer(
					player_name,
					direction,
				);
			};
	...
	},
	{
		...
		params: {
			distance: {
				type: "int",
				description: "Distance to dig down",
				domain: [1, Number.MAX_SAFE_INTEGER],
			},
		},
		perform: runAsAction(async (agent, distance) => {
	...
	},
	{
		...
		params: {
			tool_name: {
				type: "string",
				description: 'Name of the tool to use, or "hand" for no tool.',
			},
			target: {
				type: "string",
				description:
					'The target as an entity type, block type, or "nothing" for no target.',
			},
		},
